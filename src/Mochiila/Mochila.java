...
public class Mochila {
    ...
    public Mochila(ArrayList<Articulo> articulos, int _W) { //Constructor de la clase con el tamaño _W y los articulos
 ...
 public void imprimirArticulos() {
    ...
    public static void main(String[] args) {
        ...
        Mochila m = new Mochila(articulos, 15); //Mochila(articulos,tamaño _W).
        m.imprimirArticulos();
        m.buscarSolucion();
